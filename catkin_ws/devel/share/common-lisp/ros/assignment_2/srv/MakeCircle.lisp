...
(cl:in-package assignment_2-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <MakeCircle-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MakeCircle-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name assignment_2-srv:<MakeCircle-request> is deprecated: use assignment_2-srv:MakeCircle-request instead.")))

(cl:ensure-generic-function 's-val :lambda-list '(m))
(cl:defmethod s-val ((m <MakeCircle-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader assignment_2-srv:s-val is deprecated.  Use assignment_2-srv:s instead.")
  (s m))

(cl:ensure-generic-function 'r-val :lambda-list '(m))
(cl:defmethod r-val ((m <MakeCircle-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader assignment_2-srv:r-val is deprecated.  Use assignment_2-srv:r instead.")
  (r m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MakeCircle-request>)))
  ...
  "assignment_2/MakeCircleRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MakeCircle-request)))
  "Returns string type for a service object of type 'MakeCircle-request"
  "assignment_2/MakeCircleRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <MakeCircle-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MakeCircle-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name assignment_2-srv:<MakeCircle-response> is deprecated: use assignment_2-srv:MakeCircle-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MakeCircle-response>)))
  ...
  "assignment_2/MakeCircleResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MakeCircle-response)))
  "Returns string type for a service object of type 'MakeCircle-response"
  "assignment_2/MakeCircleResponse")
